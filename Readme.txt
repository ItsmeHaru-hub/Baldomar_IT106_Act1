  ...
  573  git commit
  574  git add Readme.txt
  575  git commit -m "Updated Readme.txt"
  576  git push origin Ken_Branch1
  577  git checkout main
  578  git merge Ken_Branch1
  579  nano Readme.txt
  580  nano Profile.txt
  581  git checkout Ken_Branch1
  582  git push origin main
  583  git commit -m "Updated Readme.txt"
  584  git merge Ken_Branch1
  585  git reset --hard
  586  git checkout main
  587  git checkout Ken_Branch1
  588  git merge main
  589  git add
  590  git add .
  591  git commit -m "Merged Ken_Banch1 into main"
  592  git push origin Ken_Branch1
  593  git rm -r *
  594  git reset --hard
  595  for file in *; do  if [ "$file" != "Profile.txt" ]; then    > "$file";  fi; done
  596  nano Profile.txt
  597  git add .
  598  git commit
  599  git commit -m "Updated Profile.txt"
  600  git push origin Ken_Branch1
  601  history > Readme.txt
  602  git add .
  603  git add Readme.txt
  604  git commit -m "Updated Readme.txt"
  605  git push origin Ken_Branch1
  606  git checkout main
  607  git pull origin main
  608  git merge Ken_Branch1
  609  git add .
  610  git commit -m "Merged Ken_Branch1 into main (conbined file contents)"
  611  git push origin main
  612  git log --oneline
  613  git revert -m 1 21eebef
  614  nano Profile.txt
  615  nano Education.txty
  616  nano Education.txt
  617  nano Test.py
  618  git add .
  619  git commit -m "Merges from all Branches"
  620  git push origin main
  621  nano Background.txt
  622  git add .
  623  git add Background.txt
  624  git commit -m "Merged from all Branches"
  625  git push origin main
  626  history > Readme.txt
